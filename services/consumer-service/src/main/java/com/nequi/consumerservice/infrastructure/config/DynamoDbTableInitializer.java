...
/**
 * Creates DynamoDB tables required by consumer-service on startup.
 *
 ...
 * <p>Tables created:
 * <ol>
 *   <li>{@code emp-orders} — PK/SK + GSI1</li>
 *   <li>{@code emp-outbox} — PK/SK + GSI1 (published flag) + TTL</li>
 *   <li>{@code emp-reservations} — PK/SK + GSI1 (status/expiresAt) + TTL</li>
...
public class DynamoDbTableInitializer {
    ...
    private void createReservationsTable() {
        ...
        try {
            ...
            log.error("Failed to initialize DynamoDB table: {}", reservationsTableName, ex);
