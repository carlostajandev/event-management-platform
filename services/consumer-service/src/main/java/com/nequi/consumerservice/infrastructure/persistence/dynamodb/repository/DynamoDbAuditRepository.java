...
import com.nequi.consumerservice.infrastructure.persistence.dynamodb.entity.AuditEntity;
...
/**
 * DynamoDB implementation of {@link AuditRepository} for consumer-service.
 *
 * <p>Writes audit entries for order and reservation state transitions:
 * <ul>
 *   <li>ORDER: PENDING_CONFIRMATION → CONFIRMED</li>
 *   <li>RESERVATION: ACTIVE → CONFIRMED</li>
 * </ul>
 *
