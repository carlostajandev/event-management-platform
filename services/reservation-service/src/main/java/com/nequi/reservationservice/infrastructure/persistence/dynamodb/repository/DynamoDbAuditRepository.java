...
import com.nequi.reservationservice.infrastructure.persistence.dynamodb.entity.AuditEntity;
...
/**
 * DynamoDB implementation of {@link AuditRepository}.
 *
 ...
 * </ul>
 *
 * <p>Protected by {@code @CircuitBreaker(name = "dynamodb")} — audit write failures
 * open the circuit rather than cascading to the reservation flow.
 */
@Slf4j
@Repository
